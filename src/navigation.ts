      ...
      links: [
        {
          ...
          href: getPermalink('/Consult'),
        },
        {
          text: 'GenAI',
          href: getPermalink('/GenAI'),
        },
        {
          text: 'Data Engineering',
          href: getPermalink('/DataEngineering'),
        },
        {
          text: 'Custom Machine Learning',
          href: getPermalink('/ML'),
        },
        {
          text: 'Computer Vision',
          href: getPermalink('/ComputerVision'),
        },
        {
          text: 'IOT',
          href: getPermalink('/IOT'),
        },
        // {
        //   text: 'Terms',
...
export const footerData = {
  ...
  footNote: `
    ...
    Ephoreal Technologies (OPC) PVT LMT @All rights reserved.
  `,
};
